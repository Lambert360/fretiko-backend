-- Fixed debug query - check actual table structure first
...
-- 3. Check wallet_ledger table structure first
SELECT column_name, data_type 
FROM information_schema.columns 
WHERE table_name = 'wallet_ledger' 
ORDER BY ordinal_position;

-- 4. Check if there are any existing transactions for this order (using correct column names)
SELECT *
FROM wallet_ledger
...
-- 5. Test the wallet function directly with debug logging
SELECT *
