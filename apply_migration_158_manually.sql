-- Migration: Apply migration 158 manually
-- Description: Manually apply the fixes from migration 158 to resolve ESCROW_REFUND errors
-- This should be run directly in Supabase SQL editor if migrations aren't applying automatically

-- Apply the fixed process_wallet_transaction function
