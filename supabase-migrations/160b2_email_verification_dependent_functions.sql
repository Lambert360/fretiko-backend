-- =====================================================
-- PART 2B: EMAIL VERIFICATION - DEPENDENT FUNCTIONS
-- =====================================================
-- Migration: Add email verification functions that depend on others
-- Description: Creates functions that reference previously created functions
-- Date: 2026-03-01
-- Prerequisites: Must run 160a_email_verification_tables.sql AND 160b1_email_verification_individual_functions.sql first

-- =====================================================
-- CREATE EMAIL VERIFICATION FUNCTIONS (DEPENDENT)
-- =====================================================
...
-- This part adds:
-- ✅ Email verification function (depends on token validation)
