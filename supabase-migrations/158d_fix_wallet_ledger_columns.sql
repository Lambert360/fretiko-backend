-- Migration: Fix wallet_ledger column names in process_wallet_transaction - Version 158d
-- Description: Fix INSERT statement to use correct column names (available_delta, escrow_delta, pending_withdrawal_delta instead of amount)
...
BEGIN
  ...
  -- 5. Create transaction record - 🔧 FIXED: Use correct column names
