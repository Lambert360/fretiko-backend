-- Migration to add vendor_sale transaction type to process_wallet_transaction RPC function
-- This enables proper sales tracking for vendors
...
-- Add comment
COMMENT ON FUNCTION process_wallet_transaction IS 'Atomically process wallet transactions with balance updates and ledger entries. Now supports vendor_sale transaction type.';
